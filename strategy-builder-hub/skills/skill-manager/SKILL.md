...
The twelve first-party plugins that ship with claude-for-strategy are off-limits from this
...
`market-intelligence`, `transformation`, `change-management`, `operating-model`, `performance`,

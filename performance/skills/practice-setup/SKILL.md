...
description: >
  ...
  "/performance:practice-setup" (with optional --quick, --full,
...
Read and follow `../../references/practice-setup-framework.md` with `performance` as the plugin name.

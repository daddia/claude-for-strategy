...
# Modified for claude-for-strategy: cookbook path is managed-agents/ (upstream:
# managed-agent-cookbooks/). See NOTICE.
...
#   e.g. scripts/deploy-managed-agent.sh escalation-watcher

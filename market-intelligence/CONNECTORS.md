...
- **Whiteboard** (Miro) matters here — strategic-group maps are genuinely visual (clusters with mobility-barrier arrows between them); a table is a lossy representation.

...
description: >
  ...
  "/transformation:practice-setup" (with optional --quick, --full,
...
Read `../../references/practice-setup-framework.md` with `transformation` as plugin name.

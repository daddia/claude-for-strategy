...
description: >
  ...
  "/corporate-strategy:practice-setup" (with optional --quick, --full,
...
---
# Practice Setup — corporate-strategy
...
Read `../../references/practice-setup-framework.md` with `corporate-strategy` as plugin name.

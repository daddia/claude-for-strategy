...
description: >
  ...
  "/balanced-scorecard:practice-setup" (with optional --quick, --full,
...
---
# Practice Setup — balanced-scorecard
...
| For `--resume`: `practice-setup-resume.json` | Report no session; offer fresh start |
...
Read and follow `../../references/practice-setup-framework.md` with `balanced-scorecard` as the plugin name.

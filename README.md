...
scripts/                  # validate.py · sync-references.py · check-marketplace-sync.py · check-skill-frontmatter.py · validate-connectors.py · lint-tool-scope.py · deploy-managed-agent.sh

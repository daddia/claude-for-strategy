...
- **MCP connectors** across general productivity (Slack, Google Workspace, Atlassian, Linear, Asana) and strategy-specific categories (observability, hosting, spreadsheets).

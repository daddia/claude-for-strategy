...
- **No project tracker** — this plugin diagnoses structure, it doesn't track tickets. If a diagnosis produces follow-up work (a reorg, a RACI rollout), that work belongs in whatever tracker the org already uses, outside this plugin's scope.
...
- **Whiteboard** (Miro) is pre-wired for org-design and decision-rights workshop canvases — optional unless you run those skills against live boards.

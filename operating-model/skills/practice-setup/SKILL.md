...
description: >
  ...
  "/operating-model:practice-setup" (with optional --quick, --full,
...
---
# Practice Setup — operating-model
...
Read and follow `../../references/practice-setup-framework.md` with `operating-model` as the plugin name.
